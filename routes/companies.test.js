...
describe("GET /companies", function () {
    ...
    describe("GET /companies with filter: no name", function () {
        test("query string name error", async function () {
            try {
                await request(app).get("/companies?name=");
            } catch (err) {
    ...
    describe("GET /companies with filter: num of employees error", function () {
        test("query string num of employees error", async function () {
            try {
                await request(app).get("/companies?maxEmployees=-7");
            } catch (err) {
                expect(err instanceof BadRequestError).toBeTruthy();
            }
        });
